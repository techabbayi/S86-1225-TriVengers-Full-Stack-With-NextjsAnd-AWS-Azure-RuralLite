...
export default function QuizzesPage() {
  ...
  useEffect(() => {
    if (subjectParam && quizzes && subjects.length > 0) {
      const matchingSubject = subjects.find((s) => s === subjectParam);
      if (matchingSubject) {
        setSelectedSubject(matchingSubject);
      }
    }
  }, [subjectParam, quizzes, subjects]);
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-orange-50">
        ...
        {!selectedSubject ? (
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
            ...
            <div className="mb-10 relative">
              ...
              <div className="relative p-8">
                <div className="flex items-center gap-4 mb-2">
                  <div
                    className={`w-16 h-16 bg-gradient-to-br ${getSubjectColor(selectedSubject)} rounded-2xl flex items-center justify-center shadow-lg`}
                  >
            ...
            {/* Quiz Cards Grid */}
            {quizzes?.filter((q) => q.subject === selectedSubject).length >
            0 ? (
                      ...
                      >
                        <div className="p-6">
                          ...
                          <Link href={`/quizzes/${quiz._id || quiz.id}`}>
                            ...
                            >
                              <span>
                                {isCompleted ? "View Details" : "Start Quiz"}
                              </span>
                              <svg
                                className="w-5 h-5"
                                fill="none"
