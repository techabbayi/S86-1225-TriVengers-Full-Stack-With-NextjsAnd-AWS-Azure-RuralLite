      ...
      <ul className="space-y-2">
        ...
        {(() => {
          ...
          if (typeof window !== 'undefined') {
            console.log(`[RBAC-UI] ${user?.role || 'unknown'} access to Users/Lessons links: ${allowed ? 'ALLOWED' : 'DENIED'}`);
          }
          return allowed ? <>
            <li>
            ...
            <li>
              <Link href="/lessons" className="text-gray-700 hover:text-blue-600">Lessons</Link>
            </li>
          </> : null;
        })()}
        <li>
          <Link href="/quizzes" className="text-gray-700 hover:text-blue-600">Quizzes</Link>
        </li>
        <li>
